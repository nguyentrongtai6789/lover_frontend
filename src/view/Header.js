                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                {(idAccount !== 0 && role === "ROLE_LOVER") &&
                                    <Link
                                        to={"/homeProfileLover/" + idAccount}
                                        style={{textDecoration: "none"}}>
                                        Trang lover</Link>}
                                {(idAccount !== 0 && role === "ROLE_ADMIN") &&
                                    <Link
                                        to={"/layout-admin/home/" + idAccount}
                                        style={{textDecoration: "none"}}>
                                        Trang Admin</Link>}
                                {(idAccount === null) &&
                            ...
                            <li>
                                {(idAccount !== null) &&
                                    <Link to={"/info-user/" + idAccount}
                                          style={{textDecoration: "none"}}>Thông
                                        tin cá
                                        nhân</Link>}
                                {(idAccount === null) &&
                                    <a className="nav-link scrollto"
                            ...
                            <li><a href="http://localhost:3000/"
                                   className="nav-link scrollto">Trang
                                chủ</a></li>
                            <li><a className="nav-link scrollto"
                                   href="#menu" data-bs-toggle={"modal"}
                                   data-bs-target={"#top-player"}>Top
                                player</a></li>
                            <li><a className="nav-link scrollto"
                                   href="#menu" data-bs-toggle={"modal"}
                                   data-bs-target={"#top-rich-man"}>Top
                                đại gia</a></li>

                            <li className="dropdown"><a href="#"><span>Dịch vụ</span>
                                <i
                                    className="bi bi-chevron-down"></i></a>
                                <ul>
                                    <li className="dropdown"><a
                                        href="#"><span>Dịch vụ vip</span>
                                        <i
                                    ...
                                    <li className="dropdown"><a
                                        href="#"><span>Dịch vụ miễn phí</span>
                                        <i
                                            className="bi bi-chevron-right"></i></a>
                                        <ul>
                            ...
                            <li><a href=""><i
                                className="bi bi-chat-dots"/></a></li>
                            <li><a href=""><i
                                className="bi bi-bell"/></a></li>
                            ...
                            <li className="dropdown"><a
                                href="#"><span><i
                                className="bi bi-person-circle" style={{
                                fontSize: "25px",
                                color: "#053DF3FF"
                            }}></i></span> <i
                                className="bi bi-chevron-down"></i></a>
